...
Thomas.prototype.setup = function(canvas_id) {
	if(canvas_id) {
		...
		var debugPlane = twgl.primitives.createPlaneVertices(10.0, 10.0);
    	...
    	var debugPlaneMesh = new Mesh(this.gl, this.programs["default"], this.gl.TRIANGLES, debugPlane.position, debugPlane.indices, debugPlane.normal)
...
Thomas.prototype.unbindFramebuffer = function() {
	...
	this.gl.viewport(0, 0, this.gl.canvas.width, this.gl.canvas.heigth);
};
